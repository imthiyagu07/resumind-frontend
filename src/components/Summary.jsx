    ...
    return (
        <div className='resume-summary'>
            <div className="category">
                <div className='flex flex-row gap-2 max-sm:flex-col items-center justify-center'>
    ...
    <div className='bg-white rounded-2xl shadow-md w-full'>
        <div className='flex flex-row max-sm:flex-col items-center p-4 gap-8'>
            ...
            <div className='flex flex-col gap-2'>
                <h2 className='text-2xl max-sm:text-center font-bold'>Your Resume Score</h2>
                <p className='text-sm max-sm:text-center text-gray-500'>This score is calculated based on the variables listed below.</p>
            </div>
        </div>
