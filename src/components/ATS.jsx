...
const ATS = ({ score, suggestions}) => {
    const color = score > 69 ? "from-green-100" : score > 49 ? "from-yellow-100" : "from-red-100";
  return (
    <div className={`rounded-2xl shadow-md w-full bg-gradient-to-b to-light-white p-8 flex flex-col gap-4 ${color}`}>
